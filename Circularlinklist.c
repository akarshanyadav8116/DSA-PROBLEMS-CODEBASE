...
Node* createalinklist(Node *start){
	if(start==NULL){
		...
		char ch='N';
		printf("\nDo you want to delete the previous circular link list and create a new one?(Y/N)");
		fflush(stdin);
		scanf("\n");
		scanf("%c",&ch);
		if(ch=='Y'||ch=='y'){
...
void sortll(Node *start){
	if(start==NULL){
		...
		Node *start1=start,*start2=start,*pos;
		int min;
		do{
			min=start1->data;
			start2=start1->next;
...
int main(){
	...
	printf("\n2)Print all nodes");
	printf("\n3)Insert at beginning in the circular link list");
	printf("\n4)Insert at end in the circular link list");
	printf("\n5)Insert before a node in the circular link list");
	printf("\n6)Insert after a node in the circular link list");
	printf("\n7)Delete a node in the circular link list");
	printf("\n8)Delete the circular link list");
	printf("\n9)Search in circular link list");
	printf("\n10)Sort the circular link list");
	printf("\n11)Exit");
	printf("\nEnter the option :");
	scanf("%d",&op);
	switch(op){
